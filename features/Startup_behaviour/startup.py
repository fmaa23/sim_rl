...
def find_stabilization_point(derivatives, threshold, consecutive_points):
...
def main():
    ...
    try:
        ...
        stabilization_point = find_stabilization_point(derivatives, threshold, consecutive_points)
