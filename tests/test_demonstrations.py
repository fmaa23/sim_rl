...
from evaluation.blockage_demonstrations.demonstrations import ControlEvalaution, DisruptionEvaluation
...
def test_disruption_evaluation_multi_control(disruption_evaluation):
    with patch.object(disruption_evaluation, 'control') as mock_control:
        ...
        assert mock_control.call_count == 2  # Should be called twice for normal and disrupted scenarios
